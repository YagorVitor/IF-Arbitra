...
class Event(StrEnum):
    ...
    ADMIN = "ADMIN_ACTION"
    CREDENTIAL_DISPATCH_STARTED = "CREDENTIAL_DISPATCH_STARTED"
    CREDENTIAL_DISPATCHED = "CREDENTIAL_DISPATCHED"
    CREDENTIAL_DELIVERY_FAILED = "CREDENTIAL_DELIVERY_FAILED"
    CREDENTIAL_DISPATCH_FINISHED = "CREDENTIAL_DISPATCH_FINISHED"
