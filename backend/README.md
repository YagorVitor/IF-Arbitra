...
Instale o pacote com `pip install -c requirements/constraints.txt -e ".[dev]"` dentro de `backend/`. Configure o PostgreSQL em `.env` a partir de `.env.example`. Em seguida:
